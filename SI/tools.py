...
def calc_fwhm(bb_pactive):
    '''
    Calculates the full width at half maximum of the P(active) distribution of each cluster for a given position.
    
    Input
    -----
    bb_pactive : dataframe
        dataframe containing the SMILES, P(active) and cluster ID for all the building blocks in a given position
    
    Output
    ------
    bb_fwhm : dictionary
        returns dictionary where key is the cluster ID and the value is the FWHM for the P(active) distribution of building blocks in that cluster
    '''
